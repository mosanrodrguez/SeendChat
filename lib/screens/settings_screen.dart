      ...
      body: ListView(
        ...
        children: [
          ...
          Row(children: [
            ...
            Expanded(child: _buildOption(context, Icons.share, 'Compartir', () => Share.share('Contáctame en Seend: $link', subject: 'Mi perfil de Seend'))),
          ]),
          const SizedBox(height: 24),
          const Divider(),
  ...
  Widget _buildOption(BuildContext context, IconData icon, String label, VoidCallback onTap) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(children: [Icon(icon, color: SeendColors.primary, size: 28), const SizedBox(height: 6), Text(label, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500))]),
      ),
    );
  }
}
